...
25) assign function pretty much  creates a vector with size and capacity=count and values same as the value passed as arg ,if something goes wrong assign doesn't do anything (strong guarantee), if all goes good we dealloc our old vector and take this one
...
THE ITERATOR CLASS IS ALSO A TEMPLATE CLASS
